    ...
    <div class="col-lg-10">
        <div class="card form-card mb-4">
            <div class="form-card-header">
                <h5 class="m-0"><i class="fa-solid fa-pen-to-square me-2"></i>แก้ไขรายละเอียดห้องปฏิบัติการ</h5>
            ...
            <div class="card-body p-4">
                ...
                <form action="/laboratories/update/<?= $lab['id'] ?>" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            <label for="status" class="form-label">สถานะของห้องปฏิบัติการ</label>
                            <select class="form-select" id="status" name="status">
                                <option value="active" <?= $lab['status'] === 'active' ? 'selected' : '' ?>>เปิดใช้งานอยู่</option>
                                <option value="inactive" <?= $lab['status'] === 'inactive' ? 'selected' : '' ?>>ปิดใช้งาน</option>
                            </select>
                        </div>
                    </div>
