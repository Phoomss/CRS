    ...
    <div class="col-lg-10">
        <div class="card mb-4">
            <div class="card-header border-0 pb-0">
                <h5 class="fw-bold m-0"><i class="fa-solid fa-square-plus text-primary me-2"></i>Add User Account</h5>
                ...
                <form action="/users/store" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?= isset($errors['first_name']) ? 'is-invalid' : '' ?>" id="first_name" name="first_name" placeholder="e.g. John" value="<?= esc($old['first_name'] ?? '') ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?= isset($errors['last_name']) ? 'is-invalid' : '' ?>" id="last_name" name="last_name" placeholder="e.g. Doe" value="<?= esc($old['last_name'] ?? '') ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control <?= isset($errors['email']) ? 'is-invalid' : '' ?>" id="email" name="email" placeholder="e.g. john.doe@lab.edu" value="<?= esc($old['email'] ?? '') ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="e.g. 0123456789" value="<?= esc($old['phone_number'] ?? '') ?>">
                        </div>
                    </div>

                    <div class="row g-3 mb-4">
                        <h6 class="text-secondary small text-uppercase fw-semibold m-0">Account Role & Credentials</h6>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4" id="student-id-wrapper" style="display: none;">
                            ...
                            <input type="text" class="form-control <?= isset($errors['student_id']) ? 'is-invalid' : '' ?>" id="student_id" name="student_id" placeholder="e.g. STD001" value="<?= esc($old['student_id'] ?? '') ?>">
                        ...
                        <div class="col-md-4" id="employee-id-wrapper" style="display: none;">
                            ...
                            <input type="text" class="form-control <?= isset($errors['employee_id']) ? 'is-invalid' : '' ?>" id="employee_id" name="employee_id" placeholder="e.g. EMP001" value="<?= esc($old['employee_id'] ?? '') ?>">
                        ...
                        <div class="col-md-4">
                            ...
                            <?php if (isset($errors['password'])): ?>
                                <div class="invalid-feedback"><?= esc($errors['password'][0]) ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 border-top border-secondary border-opacity-10 pt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4 py-2"><i class="fa-solid fa-save me-1"></i> Save User Account</button>
                    </div>
                </form>
