...
<div class="card report-table-card mb-4">
    <div class="report-table-header">
        <h5 class="m-0"><i class="fa-solid fa-display me-2"></i>วิเคราะห์การใช้งานเครื่องคอมพิวเตอร์รายเครื่อง</h5>
        <div class="d-flex gap-2">
            <button onclick="window.print();" class="btn btn-outline-light btn-sm"><i class="fa-solid fa-print me-1"></i> พิมพ์รายงาน</button>
            <a href="/reports/export/computers" class="btn btn-success btn-sm"><i class="fa-solid fa-file-csv me-1"></i> ส่งออกไฟล์ Excel</a>
            ...
            <table class="table report-data-table align-middle m-0" id="report-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-end">เวลารวมเปิดใช้งาน (ชม.)</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (empty($data)): ?>
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">ยังไม่มีการบันทึกประวัติการใช้งานเครื่องคอมพิวเตอร์ในระบบ</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($data as $row): ?>
                            <tr>
                                ...
                                <td><span class="fw-semibold text-dark"><?= esc($row['laboratory_name']) ?></span></td>
                                ...
                                <td class="text-end fw-semibold text-dark"><?= round(($row['total_minutes'] ?? 0) / 60, 1) ?> ชม.</td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
